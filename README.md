...
```
## OUTPUT WAVEFORM
![image](https://github.com/user-attachments/assets/eb4b06db-c0f6-47eb-a12d-d38ecd757990)


## HARDWARE EXPERIMENT WAVEFORM:
![WhatsApp Image 2025-04-27 at 10 48 03_2bbb3f26](https://github.com/user-attachments/assets/d9629541-a56d-44f9-9f49-8eacb25e8639)


# RESULTS :
Thus the Python program for the modulation and demodulation of FSK is simulated successfully.
